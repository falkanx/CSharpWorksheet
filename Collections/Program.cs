...
namespace Collections
{
    class Program
    {
        ...
        private static void List()
        {
            ...
            //customers.Add(new Customer { Id = 2, FirstName = "Çağrı" });

            List<Customer> customers = new List<Customer>
            {
                new Customer {Id = 1, FirstName = "Furkan"},
                new Customer {Id = 2, FirstName = "Çağrı"}
            };
            ...
            {
                new Customer {Id = 4, FirstName = "Mustafa"},
                new Customer {Id = 5, FirstName = "Ömer"}
            });
            ...
            //customers.Remove(customer2);
            //customers.Remove(customer2);
            customers.RemoveAll(c => c.FirstName == "Kemal");
